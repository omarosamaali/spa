    ...
    public static function presets(): array
    {
        return [
            ...
            'nirvana' => [
                ...
                'dark_3'         => '#faf7f2',
                'text_body'      => '#4a3728',
                'hero_gradient'  => 'linear-gradient(135deg,rgba(245,240,232,0.05) 0%,rgba(181,151,122,0.2) 100%)',
            ...
            'vera' => [
                ...
                'dark_3'         => '#071a12',
                'text_body'      => '#d1fae5',
                'hero_gradient'  => 'linear-gradient(135deg,rgba(13,43,30,0.92) 0%,rgba(5,150,105,0.35) 55%,rgba(16,78,42,0.7) 100%)',
            ...
            'elira' => [
                ...
                'dark_3'         => '#130a1c',
                'text_body'      => '#f3e8ff',
                'hero_gradient'  => 'linear-gradient(135deg,rgba(30,16,40,0.92) 0%,rgba(147,51,234,0.3) 55%,rgba(60,20,80,0.8) 100%)',
            ...
            'solea' => [
                ...
                'dark_3'         => '#fff9f3',
                'text_body'      => '#4a2e18',
                'hero_gradient'  => 'linear-gradient(135deg,rgba(74,46,24,0.85) 0%,rgba(160,112,78,0.4) 55%,rgba(100,60,30,0.7) 100%)',
                'nav_gradient'   => 'linear-gradient(135deg,#4a2e18 0%,#6b3f22 40%,#a0704e 100%)',
                'preview_colors' => ['#d4a574', '#a0704e', '#c9892e', '#4a2e18'],
            ],
            ...
            'bella_rose' => [
                ...
                'dark_3'         => '#100610',
                'text_body'      => '#fce7f3',
                'hero_gradient'  => 'linear-gradient(135deg,rgba(26,10,18,0.92) 0%,rgba(219,39,119,0.3) 55%,rgba(60,10,40,0.8) 100%)',
            ...
            'azure' => [
                ...
                'dark_3'         => '#f8feff',
                'text_body'      => '#164e63',
                'hero_gradient'  => 'linear-gradient(135deg,rgba(22,78,99,0.85) 0%,rgba(8,145,178,0.35) 55%,rgba(6,182,212,0.4) 100%)',
                'nav_gradient'   => 'linear-gradient(135deg,#164e63 0%,#0e7490 40%,#0891b2 100%)',
                'preview_colors' => ['#22d3ee', '#0891b2', '#cffafe', '#164e63'],
            ],
            ...
            'maison_dor' => [
                ...
                'dark_3'         => '#0f0d04',
                'text_body'      => '#fef3c7',
                'hero_gradient'  => 'linear-gradient(135deg,rgba(26,20,8,0.92) 0%,rgba(217,119,6,0.35) 55%,rgba(80,50,10,0.8) 100%)',
            ...
            'pureli' => [
                ...
                'dark_3'         => '#06120b',
                'text_body'      => '#dcfce7',
                'hero_gradient'  => 'linear-gradient(135deg,rgba(10,31,18,0.92) 0%,rgba(22,163,74,0.3) 55%,rgba(20,60,30,0.8) 100%)',
