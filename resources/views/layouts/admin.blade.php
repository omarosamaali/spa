    ...
    <aside class="w-64 flex-shrink-0 flex flex-col admin-sidebar admin-sidebar--fixed">
        ...
        <nav class="admin-sidebar__nav p-4 space-y-1 flex-1 min-h-0">
            ...
            $navItems = [
                ...
                ['route'=>'admin.service-categories', 'label'=>'تصنيفات الخدمات',
                 'svg'=>'<path d="M4 6h16M4 12h16M4 18h7"/>'],
                ['route'=>'admin.home-service-filters', 'label'=>'فلتر الرئيسية',
                 'svg'=>'<line x1="4" y1="21" x2="4" y2="14"/><line x1="4" y1="10" x2="4" y2="3"/><line x1="12" y1="21" x2="12" y2="12"/><line x1="12" y1="8" x2="12" y2="3"/><line x1="20" y1="21" x2="20" y2="16"/><line x1="20" y1="12" x2="20" y2="3"/>'],
                ['route'=>'admin.about-settings', 'label'=>'عن المركز',
                ...
                ['route'=>'admin.equipment', 'label'=>'الأجهزة',
                 'svg'=>'<rect x="2" y="6" width="20" height="12" rx="2"/><line x1="6" y1="10" x2="6" y2="14"/><line x1="10" y1="10" x2="10" y2="14"/>'],
                ...
                ['route'=>'admin.whatsapp-settings', 'label'=>'واتساب تلقائي',
                ...
                ['route'=>'admin.promo-settings', 'label'=>'بطاقة العرض',
                 'svg'=>'<rect x="3" y="5" width="18" height="14" rx="2"/><path d="M7 15h4M7 11h10M7 7h6"/>'],
                ...
                ['route'=>'admin.home-gallery', 'label'=>'معرض الرئيسية',
